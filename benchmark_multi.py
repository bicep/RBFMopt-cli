...
original_hv = pg.hypervolume(pop)
ref = original_hv.refpoint(offset=4.0)
hv = original_hv.compute(ref)

hv_moead_plot = calculate_mean(n, algo_moead, working_fevals, pop_size, seed, problem, get_hv_for_algo)
hv_nsga2_plot = calculate_mean(n, algo_nsga2, working_fevals, pop_size, seed, problem, get_hv_for_algo)
